	        ...
	        <?= $this->Form->create() ?>
                	...
                	<div class="form-row">
                 	...
                 	<div class="form-row">
                           ...
                           <?= $this->Form->input('nr_adults', [ 'required'=>true, 'empty'=>'Choose', 'options'=>$numbers, 'label'=>'Number of Adult Guests']); ?>
                           <?= $this->Form->input('nr_children', [ 'required'=>true, 'empty'=>'Choose', 'options'=>$numbers,  'label'=>'Number of Child Guests']); ?>
                     </div><br>


            <?= $this->Form->submit('Submit', array('class' => 'add-new ')); ?>
            <?= $this->Form->end() ?>
    </div>
</div>
